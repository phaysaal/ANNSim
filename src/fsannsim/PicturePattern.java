 ...
 * @version 1.0
 */
public class PicturePattern extends JFrame implements Serializable {
    ...
    private void jbInit() throws Exception {
        ...
        this.setTitle("File Image To Pattern Generator");
    ...
    public void btnAdd_actionPerformed(ActionEvent e) {
        if(ipInput.getCode().equals("") || ipOutput.getCode().equals("")){
            JOptionPane.showMessageDialog(this,
                                          "Failure: No data in input or output");
            return;
        }
